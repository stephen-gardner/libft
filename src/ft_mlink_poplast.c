...
/*   Updated: 2017/01/14 22:27:06 by sgardner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Returns the preceding memlink after setting its variable next
**  to NULL.
** If the freed link is the head of the memchain, the memchain
**  is also freed and NULL is returned.
